...
export function SunIcon({ size = 15 }: IconProps): ReactElement {
  return (
    <svg width={size} height={size} viewBox="0 0 16 16" {...strokeBase} strokeWidth={1.3}>
...
export function PlusIcon({ size = 15 }: IconProps): ReactElement {
  return (
    <svg width={size} height={size} viewBox="0 0 16 16" {...strokeBase} strokeWidth={1.5}>
...
export function PlusThinIcon({ size = 14 }: IconProps): ReactElement {
  return (
    <svg width={size} height={size} viewBox="0 0 16 16" {...strokeBase} strokeWidth={1.4}>
      <path d="M8 4v8M4 8h8" />
    </svg>
  )
}
...
export function ChevronRightIcon({ size = 9 }: IconProps): ReactElement {
  return (
    <svg width={size} height={size} viewBox="0 0 16 16" {...strokeBase} strokeWidth={2}>
...
export function CheckIcon({ size = 13 }: IconProps): ReactElement {
  return (
    <svg width={size} height={size} viewBox="0 0 16 16" {...strokeBase} strokeWidth={1.7}>
...
export function SqlDocIcon({ size = 34 }: IconProps): ReactElement {
  return (
    <svg width={size} height={size} viewBox="0 0 16 16" {...strokeBase} strokeWidth={1.1}>
...
export function CubeIcon({ size = 12 }: IconProps): ReactElement {
  return (
    <svg width={size} height={size} viewBox="0 0 16 16" {...strokeBase} strokeWidth={1.2}>
...
export function ExportIcon({ size = 14 }: IconProps): ReactElement {
  return (
    <svg width={size} height={size} viewBox="0 0 16 16" {...strokeBase} strokeWidth={1.35}>
